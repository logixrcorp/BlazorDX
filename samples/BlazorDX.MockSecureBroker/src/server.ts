...
export interface MockSecureBrokerApp {
  app: express.Express;
  cache: SessionCache;
  sessionManager: SecureSessionManager;
  payloadWrapper: SecurePayloadWrapper;
  auditLog: AuditLog;
}
 ...
 */
export function createApp(): MockSecureBrokerApp {
  ...
  app.post('/mcp/tools/wrap_secure_payload', (req, res) => {
    const { sessionId, plaintext } = (req.body ?? {}) as { sessionId?: unknown; plaintext?: unknown };
